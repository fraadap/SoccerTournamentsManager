...
<main>
  ...
  <div class="container px-4 py-5" id="hanging-icons">
    <h2 class="pb-2 border-bottom">Area riservata all'amministratore</h2>
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      ...
      <div class="col d-flex align-items-start">
        ...
        <div>
          ...
          <p>Il ruolo più importante per un amministratore è gestire i tornei, si possono inserire e modificare le informazioni per ogni torneo</p>
          <a href="select-tournament.php" class="btn btn-primary">
            Gestisci tornei
          </a>
        </div>
      </div>
      <div class="col d-flex align-items-start">
        ...
        <div>
          ...
          <p>Cliccare qui per cambiare la password amministratore.</p>
